...
public class MandrillRESTRequest {
	...
	public BaseMandrillResponse postRequest(BaseMandrillRequest request, String serviceMethod, Object responseClass, @SuppressWarnings("rawtypes") TypeReference reference) throws RequestFailedException {
